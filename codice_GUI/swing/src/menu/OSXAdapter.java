...
//Una classe per gestire facilmente le funzionalitˆ dei menu di MacOSX
public class OSXAdapter
{
  public static void registerMacOSXApplication(final MenuFrame inApp, boolean prefs)
  {
    ...
    if (inApp!=null)
    {
      com.apple.eawt.Application theApplication=new com.apple.eawt.Application();
      ...
      {
        //Metodo per la gestione del menu "About"
        ...
        //Metodo per la gestione del menu delle "Preferenze"
        ...
        //Metodo per la gestione del menu "Quit"
