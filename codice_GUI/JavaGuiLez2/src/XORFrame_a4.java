...
//questo esempio mostra come disegnare in modalita' XOR sia rettangoli che ellissi casuali.
//Il codice e' molto intuitivo
public class XORFrame_a4 extends JFrame
{
  public XORFrame_a4()
  {
    setTitle("un disegno");
    ...
    contentPane.add(new XORPanel_a4());
  }

  public static void main(String[] args)
  {
    JFrame frame=new XORFrame_a4();
    frame.setVisible(true);
  }
}

class XORPanel_a4 extends JPanel
{
