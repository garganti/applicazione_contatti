...
//questo esempio mostra come disegnare in modalita' XOR ellissi casuali.
//Il codice e' molto intuitivo
public class XORFrame_a3 extends JFrame
{
  public XORFrame_a3()
  {
    setTitle("un disegno");
    ...
    contentPane.add(new XORPanel_a3());
  }

  public static void main(String[] args)
  {
    JFrame frame=new XORFrame_a3();
    frame.setVisible(true);
  }
}

class XORPanel_a3 extends JPanel
{
