    ...
    while (risposta2==JOptionPane.NO_OPTION) //Finche' non decido di salvare o di rinunciare
    {
      ...
      if (risposta==fileChooser.APPROVE_OPTION) //Se ho premuto il tasto salva
      {
        try
        {
          ...
          if (f.exists()) risposta2=JOptionPane.showConfirmDialog(area,"Il file esiste gia',\nlo vuoi sovrascrivere?","Sovrascrittura",JOptionPane.YES_NO_CANCEL_OPTION,JOptionPane.QUESTION_MESSAGE);
