...
public class ArlecchinoFrame_a2 extends JFrame
{
  public ArlecchinoFrame_a2()
  {
    ...
    contentPane.add(new ArlecchinoPanel_a2());
  }

  public static void main(String[] args)
   {
    JFrame frame= new ArlecchinoFrame_a2();
    frame.setVisible(true);
   }
 }

class ArlecchinoPanel_a2 extends JPanel
{
  public void paintComponent(Graphics g)
  {
    ...
    for (int i=0;i<message.length();i++)
    {
      ...
      Font f=new Font("Monospaced",Font.BOLD,80+i*10);
      g.setFont(f);
      ...
      g.drawString(message.substring(i,i+1),posX+80*i,posY);
    }
  }
}
