...
public class BorderFrame extends JFrame
{
  public BorderFrame()
  {
    ...
    Border composto=BorderFactory.createCompoundBorder(cornice,incisa); // creazione di bordo inciso infossato a cornice
    Border composto2=BorderFactory.createTitledBorder(composto,"nono pannello"); // creazione di bordo inciso con titolo
